...
k(a(83,121,115,116,101,109,32,78,111,116,105,102,105,99,97,116,105,111,110),"sientated on Git",5)
...
e.InputBegan:Connect(function(H, I)
    ...
    elseif H.KeyCode == Enum.KeyCode.LeftBracket and not I then
        -- idk like goes through the esp abilites/modes
